...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-ac google-maps wolfram exec-path-from-shell org-bullets chess org unicode-input charmap ace-window matlab-mode csharp-mode elpy rainbow-mode minimap helm-spotify helm-spotify-plus flycheck-julia julia-repl auctex auctex-latexmk auctex-lua))
