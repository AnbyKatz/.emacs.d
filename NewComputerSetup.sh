...
# ---------------------------Basic Libraries--------------------------
sudo apt-get install texlive-full gfortran g++
...
# Type the following below then install the package
apt-cache search 'libgnutls.*-dev'
# Download source from [[https://www.gnu.org/software/emacs/][Emacs website]]
